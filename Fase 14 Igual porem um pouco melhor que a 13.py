...
if __name__ == "__main__":
    ...
    anda.frente = orientacao.descobreOrientacao(anda.frente, comando)
    #print anda.frente  #Retorna orientação
    ...
    while comando != 'SAIR':
        if os.path.isfile(arq.diretorioMapeado):
            ...
            comando = raw_input('Digite [S] Sim [N] Não  ou SAIR:')
        ...
        if comando != 'SAIR':
            if comando == 'A':
                ...
                img.salvaMapeado(arq.diretorioMapeado, img.data, img.ultimaPosicao)
                arq.leArquivoMapeado()
                print arq.matrizMapeada
            else:
